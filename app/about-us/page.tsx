  ...
  return (
    <>
      <Section
        ...
        description={
          <>
            KULAMA started in {brand.founded} as a chair, a mirror and a comb on a quiet Wrocław street. Five years on, it&rsquo;s a studio — but the chair, the mirror, and the obsession with detail haven&rsquo;t moved.
          </>
        }
      ...
      >
        <div className="grid gap-10 lg:grid-cols-12">
          <div className="space-y-5 text-base leading-relaxed text-[var(--color-ink-700)] lg:col-span-7">
            <p>
              We specialise in locs and protective styling — retwists, starter locs, braids and cornrows in the African tradition, adapted for the rhythm of European life. Whether it&rsquo;s your first set or your fifteenth, the conversation begins with your scalp, your tension tolerance, and the way you want to feel walking back out onto Plac Grunwaldzki.
            </p>
            <p>
              The studio is small on purpose. We take one client at a time, set the table for them, and don&rsquo;t hurry the parting. Hair extensions and curls aren&rsquo;t provided — we tell you exactly what to bring before your appointment. Cleansing and aftercare guidance comes home with you.
            </p>
            <p>
